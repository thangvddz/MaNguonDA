...
public class ManHinhDangNhap extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(85, 85, 85)
                        .addComponent(btnCanel, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(53, 53, 53)
    ...
    public void login() {
        if (txtPassword.getText().equals(pass) && txtUsername.getText().equals(user)) {
            ...
            ManHinhDangNhap.this.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
            ManHinhDangNhap.this.setVisible(false);
