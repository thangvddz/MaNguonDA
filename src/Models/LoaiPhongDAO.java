...
public class LoaiPhongDAO extends DAO<LoaiPhong, Integer> {
    ...
    private static final String SQL_INSERT = "INSERT INTO LOAIPHONG(TenLP, SoGiuong, giaPhong) VALUES (?,?,?)";
    private static final String SQL_UPDATE = "UPDATE LOAIPHONG SET TenLP=?, SoGiuong=?, giaPhong=? WHERE MaLP=?";
    ...
    public void insert(LoaiPhong entity) {
        jdbc.update(SQL_INSERT, entity.getTenLP(), entity.getSoGiuong(), entity.getGiaPhong());
    }

    @Override
    public void update(LoaiPhong entity) {
        jdbc.update(SQL_UPDATE, entity.getTenLP(), entity.getSoGiuong(), entity.getGiaPhong(), entity.getMaLP());
    }
